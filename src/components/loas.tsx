        ...
        <div className="flex justify-center space-x-4 mt-6">
          <div className="flex items-center p-4">
            ...
            <div className="bg-gray-200 p-3 rounded-lg">
              <p className="font-nunito text-xl text-gray-800 text-justify hyphenate">Dificuldades com o benefício assistencial, você não está sozinho, como posso ajudá-lo?</p>
            </div>
          </div>
        </div>
      ...
      <>
        ...
        <div className="flex justify-center space-x-4 mt-6">
          <div className="flex items-center p-4">
            ...
            <div className="bg-gray-200 p-3 rounded-lg">
              <p className="font-nunito text-base text-gray-800 text-justify hyphenate">Dificuldades com o benefício assistencial, você não está sozinho, como posso ajudá-lo?</p>
            </div>
          </div>
        </div>
