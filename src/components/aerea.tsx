    ...
    return(
      <>
        <div className="flex justify-center space-x-4 py-8 bg-white">
          <Image src='/aerea.png' alt="Imagem" width={505} height={358} />
        </div>
        ...
        <div className="flex justify-center space-x-4 mt-6">
          <div className="flex items-center p-4">
            ...
            <div className="bg-gray-200 p-3 rounded-lg">
              <p className="font-nunito text-xl text-gray-800 text-justify hyphenate">Dificuldades com o embarque, perdeu o voo, você não está sozinha, posso ajudá-la?</p>
            </div>
          </div>
        </div>
    ...
    return(
      <>
        <div className="flex justify-center space-x-4 py-0 bg-white border-b border-slate-700 shadow-2xl">
          <Image src='/aerea.png' alt="Imagem" width={1011} height={716} />
        </div>
        ...
        <div className="flex justify-center space-x-4 mt-6">
          <div className="flex items-center p-4">
            ...
            <div className="bg-gray-200 p-3 rounded-lg">
              <p className="font-nunito text-base text-gray-800 text-justify hyphenate">Dificuldades com o embarque, perdeu o voo, você não está sozinha, posso ajudá-la?</p>
            </div>
          </div>
        </div>
